...
Create a Redis Cloud on AWS Subscription, deploy Redis Enterprsie Database into Subscription, and VPC peer subscription to customer AWS VPC using the Redis Cloud Terraform Provider. ([link](https://registry.terraform.io/providers/RedisLabs/rediscloud/latest/docs))
